...
More information from inti project: <https://inkaverse.com/>
...
label <- label_layout(size = c(5.08, 5.08)
  ...
  include_image(value = "logo_inti.jpg" 
                , size = c(3.97, 3.97)
...
![](inti_files/figure-html/unnamed-chunk-2-1.png)
